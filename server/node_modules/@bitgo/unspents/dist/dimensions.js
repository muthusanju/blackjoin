 ...
 */
exports.OutputDimensions = t.refinement(t.struct({
    count: types_1.PositiveInteger,
    size: types_1.PositiveInteger,
}), 
 ...
 */
exports.Dimensions = t.struct({
    nP2shInputs: types_1.PositiveInteger,
    nP2shP2wshInputs: types_1.PositiveInteger,
    nP2wshInputs: types_1.PositiveInteger,
    outputs: exports.OutputDimensions,
}, { name: 'Dimensions' });
const zero = Object.freeze(exports.Dimensions({
    nP2shInputs: 0,
    nP2shP2wshInputs: 0,
    nP2wshInputs: 0,
 ...
 * @return {any}
 */
exports.Dimensions.zero = function () {
    return zero;
};
Object.defineProperty(exports.Dimensions.prototype, 'nInputs', {
    /**
...
Object.defineProperty(exports.Dimensions.prototype, 'nOutputs', {
    /**
...
const mapDimensions = (dim, func) => {
    return exports.Dimensions(_.fromPairs(_.map(exports.Dimensions.meta.props, (prop, key) => [key, func(dim[key], key, prop)])));
};
exports.Dimensions.ASSUME_P2SH = Symbol('assume-p2sh');
exports.Dimensions.ASSUME_P2SH_P2WSH = Symbol('assume-p2sh-p2wsh');
exports.Dimensions.ASSUME_P2WSH = Symbol('assume-p2wsh');
/**
 * @param args - Dimensions (can be partially defined)
 * @return {Dimensions} sum of arguments
 */
exports.Dimensions.sum = function (...args) {
    return args.reduce((a, b) => exports.Dimensions(a).plus(b), zero);
};
/**
 * @param chain
 * @return {Number}
 */
exports.Dimensions.getOutputScriptLengthForChain = function (chain) {
    if (!codes_1.default.isValid(chain)) {
        throw new TypeError('invalid chain code');
    }
    return codes_1.default.isP2wsh(chain) ? 34 : 23;
};
/**
 * @param scriptLength
 * @return {Number} vSize of an output with script length
 */
exports.Dimensions.getVSizeForOutputWithScriptLength = function (scriptLength) {
    ...
    return scriptLength + compactSize(scriptLength) + exports.VirtualSizes.txOutputAmountSize;
};
/**
 ...
 */
exports.Dimensions.fromInput = function ({ index, script, witness }, params = {}) {
    const p2shInput = exports.Dimensions.sum({ nP2shInputs: 1 });
    const p2shP2wshInput = exports.Dimensions.sum({ nP2shP2wshInputs: 1 });
    const p2wshInput = exports.Dimensions.sum({ nP2wshInputs: 1 });
    if (!script.length) {
        if (witness.length > 0) {
            return p2wshInput;
        }
        ...
        if (assumeUnsigned === exports.Dimensions.ASSUME_P2SH) {
            return p2shInput;
        }
        if (assumeUnsigned === exports.Dimensions.ASSUME_P2SH_P2WSH) {
            return p2shP2wshInput;
        }
        if (assumeUnsigned === exports.Dimensions.ASSUME_P2WSH) {
            return p2wshInput;
        }
 ...
 */
exports.Dimensions.fromInputs = function (inputs, params) {
    if (!Array.isArray(inputs)) {
        throw new TypeError(`inputs must be array`);
    }
    return exports.Dimensions.sum(...inputs.map((i) => exports.Dimensions.fromInput(i, params)));
};
/**
 * @param scriptLength {PositiveInteger} - size of the output script in bytes
 * @return {Dimensions} - Dimensions of the output
 */
exports.Dimensions.fromOutputScriptLength = function (scriptLength) {
    return exports.Dimensions.sum({
        outputs: {
            count: 1,
            size: exports.Dimensions.getVSizeForOutputWithScriptLength(scriptLength),
        },
    });
};
/**
 ...
 */
exports.Dimensions.fromOutput = function ({ script }) {
    if (!script) {
    ...
    return exports.Dimensions.fromOutputScriptLength(script.length);
};
/**
 * @param outputs - Array of outputs
 * @return {Dimensions} sum of the dimensions for each output (@see Dimensions.fromOutput())
 */
exports.Dimensions.fromOutputs = function (outputs) {
    if (!Array.isArray(outputs)) {
        throw new TypeError(`outputs must be array`);
    }
    return exports.Dimensions.sum(...outputs.map(exports.Dimensions.fromOutput));
};
/**
 ...
 */
exports.Dimensions.fromOutputOnChain = function (chain) {
    return exports.Dimensions.fromOutputScriptLength(exports.Dimensions.getOutputScriptLengthForChain(chain));
};
/**
 ...
 */
exports.Dimensions.fromUnspent = ({ chain }) => {
    if (!codes_1.default.isValid(chain)) {
        throw new TypeError('invalid chain code');
    }
    if (codes_1.default.isP2sh(chain)) {
        return exports.Dimensions.sum({ nP2shInputs: 1 });
    }
    if (codes_1.default.isP2shP2wsh(chain)) {
        return exports.Dimensions.sum({ nP2shP2wshInputs: 1 });
    }
    if (codes_1.default.isP2wsh(chain)) {
        return exports.Dimensions.sum({ nP2wshInputs: 1 });
    }
 ...
 */
exports.Dimensions.fromUnspents = function (unspents) {
    ...
    return exports.Dimensions.sum(...unspents.map(exports.Dimensions.fromUnspent));
};
/**
 ...
 * @return {Dimensions}
 */
exports.Dimensions.fromTransaction = function ({ ins, outs }, params) {
    return exports.Dimensions.fromInputs(ins, params).plus(exports.Dimensions.fromOutputs(outs));
};
/**
 * @param dimensions (can be partially defined)
 * @return new dimensions with argument added
 */
exports.Dimensions.prototype.plus = function (dimensions) {
 ...
 * @return {Dimensions}
 */
exports.Dimensions.prototype.times = function (factor) {
 ...
 */
exports.Dimensions.prototype.getNInputs = function () {
    return this.nP2shInputs + this.nP2shP2wshInputs + this.nP2wshInputs;
};
/**
 * @returns {boolean} true iff dimensions have one or more (p2sh)p2wsh inputs
 */
exports.Dimensions.prototype.isSegwit = function () {
    return (this.nP2wshInputs + this.nP2shP2wshInputs) > 0;
};
/**
 * @return {Number} overhead vsize, based on result isSegwit().
 */
exports.Dimensions.prototype.getOverheadVSize = function () {
    return this.isSegwit()
        ? exports.VirtualSizes.txSegOverheadVSize
        : exports.VirtualSizes.txOverheadSize;
};
/**
 * @returns {number} vsize of inputs, without transaction overhead
 */
exports.Dimensions.prototype.getInputsVSize = function () {
    const { txP2shInputSize, txP2shP2wshInputSize, txP2wshInputSize, } = exports.VirtualSizes;
    const { nP2shInputs, nP2shP2wshInputs, nP2wshInputs, } = this;
 ...
 */
exports.Dimensions.prototype.getOutputsVSize = function () {
 ...
 */
exports.Dimensions.prototype.getVSize = function () {
    return this.getOverheadVSize() + this.getInputsVSize() + this.getOutputsVSize();
};
{
    const singleOutput = (size) => Object.freeze(exports.Dimensions.sum({ outputs: { count: 1, size } }));
    exports.Dimensions.SingleOutput = {
        p2sh: singleOutput(exports.VirtualSizes.txP2shOutputSize),
        p2shP2wsh: singleOutput(exports.VirtualSizes.txP2shP2wshOutputSize),
        p2wsh: singleOutput(exports.VirtualSizes.txP2wshOutputSize),
        p2pkh: singleOutput(exports.VirtualSizes.txP2pkhOutputSize),
        p2wpkh: singleOutput(exports.VirtualSizes.txP2wpkhOutputSize),
    };
}
