 ...
 */
export declare function utxo(name: string, fullName: string, network: UtxoNetwork, asset: UnderlyingAsset, features?: CoinFeature[], prefix?: string, suffix?: string): Readonly<UtxoCoin>;
